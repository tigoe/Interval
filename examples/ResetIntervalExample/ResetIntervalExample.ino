/*
  ResetIntervalExample

  Shows how to use the reset function of the Interval library.
  Runs an interval that blinks an LED every three seconds. When you press
  a pushbutton on pin 4, the interval is reset.
...
void loop() {
  ...
  if (buttonState != previousButtonState) {
    ...
    if (buttonState == HIGH) {
      Serial.println("Button pressed. Interval reset");
      // reset the interval:
      ledTimer.reset();
    }
